...
void resolve_refs() {
    ...
    //     printf("Name: %s | FuncAddr: %lld | CodeAddr: %lld | Type: %d\n", refrences[i].name, refrences[i].func_idx, refrences[i].addr, (int64_t) refrences[i].type);
    // }
    // printf("======\n");
    // for (int32_t i = 0; i < unresolved_refrences_size; i++) {
    //     printf("Name: %s | FuncAddr: %lld | CodeAddr: %lld | Type: %d\n", unresolved_refrences[i].name, unresolved_refrences[i].func_idx, unresolved_refrences[i].addr, (int64_t) unresolved_refrences[i].type);
    // }
    bool found;
    uint64_t found_addr;
